$(document).ready(function(){
	...
	$(".list-group-item-link-parent").click(function(){
		...
		if(  $(this).find(".img-arrow").attr("src") == "/oa/suport/img/j14.png"){
			
			$(".list-group-item-link-parent").find(".img-arrow").attr("src","/oa/suport/img/j14.png")
	...
	$( "#face-switch" ).click(function(){
		if( $(this).hasClass("switch-on") ){
			...
			$(this).attr("src","/oa/suport/img/j14.png");
		}else{
			$("#face").fadeIn();
			$(this).removeClass("switch-off");
			$(this).addClass("switch-on");
			$(this).attr("src","/oa/suport/img/j15.png");
		}
	});
	...
	$("#slide-switch-1").click(function(){
		...
		if( $(this).hasClass("switch-on") ){
			...
			$(this).removeClass("switch-on");
			$(this).addClass("switch-off");
			$(this).attr("src","/oa/suport/img/right.png");
		}else{
			$("#panel-left").animate( {"width":"200px"} , 400 );
			$("#panel-left-top").animate( {"left":"0px"} , 400 );
			$(this).removeClass("switch-off");
			$(this).addClass("switch-on");
			$(this).attr("src","/oa/suport/img/rrow.png");
		}
	});
	...
	$(".list-group-item-url,.cap-title").click(function abc(){
		...
		if( flag == 0 ){
			...
			$("#panel-right-nav-head").append( "<div id='"+url+"' class='left cap-title cap-title-active hand' align='center'><img src='/oa/suport/img/57323.png' height='20px' class='img img-circle hand'/> "+$(this).text()+" &nbsp;&nbsp;<div class='div-close float-right' >×</div></div>" );
			$(".iframe-index").stop(true,true);
			$(".iframe-index").css({"top":"30px","opacity":"0"});
			$(".iframe-index").animate({"top":"0px","opacity":"1.0"},600);
			$(".cap-title").click( abc );
    ...
    $(".new-iframe").click(function abc(){
        ...
        if( flag == 0 ){
            ...
            $(window.parent.document).find("#panel-right-nav-head").append("<div id='" + url + "' class='left cap-title cap-title-active hand' align='center'><img src='/oa/suport/img/57323.png' height='20px' class='img img-circle hand'/> " + $(this).text() + " &nbsp;&nbsp;<div class='div-close float-right' >×</div></div>");
            $(window.parent.document).find(".iframe-index").stop(true, true);
            $(window.parent.document).find(".iframe-index").css({ "top": "30px", "opacity": "0" });
            $(window.parent.document).find(".iframe-index").animate({ "top": "0px", "opacity": "1.0" }, 600);
